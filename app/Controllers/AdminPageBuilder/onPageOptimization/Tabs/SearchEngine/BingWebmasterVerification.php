...
class BingWebmasterVerification {
    /**
     * @var type Obj
     */
    protected $http;
    ...
    public function load_page_builder( $common_text ){
        ...
        // check for token
        $data = array_merge( CommonText::form_element( 'save_bing_meta_tag', 'bing-webmaster-verification' ), array(
           'CommonText' => $common_text,
           'page_title' =>  __( 'Bing Site Verification', SR_TEXTDOMAIN ),
           'page_subtitle' =>  __( 'This section lets you automatically verifiy ownership of websites or domains with Bing Webmaster Tool.', SR_TEXTDOMAIN ),
           'panel_site_subtitle' => __( 'Site Verification', SR_TEXTDOMAIN ),
           'label_meta_tag' => __( 'Website URL*', SR_TEXTDOMAIN ),
           'placeholder_meta_tag' => __( 'Enter Meta Tag Content. Example: A703043D9637995795168354890BB7BA', SR_TEXTDOMAIN ),
           'des_meta_tag_1' => __( "Enter here your meta tag from Bing webmaster. Example: A703043D9637995795168354890BB7BA", SR_TEXTDOMAIN ),
           'verify_meta_tag' => isset($this->options->webmaster_verify_code->bing) ? $this->options->webmaster_verify_code->bing : '',
           ...
           'app_create_hints' => array(
               sprintf(__( '%1$s Sign up / Login %2$s here %1$s%3$s%2$s to submit your website.', SR_TEXTDOMAIN ), '<a href="https://www.bing.com/toolbox/webmaster" target="_blank">', '</a>' , 'https://www.bing.com/toolbox/webmaster' ),
               ...
               __( 'Go Back to the Bing webmaster tool page and click Verify button bellow of the page. Your website will be verified successfully.', SR_TEXTDOMAIN )
           )
       ));
       add_action('admin_footer', [$this, '_addFooter_script']);
       return  view( '@CsSeoMegaBundlePack/onPageOptimization/tabs/SearchEngine/BingWebmasterVerification.twig', $data );
    }
    ...
    private function verification_status(){
        $notificatoin = '';
        if( isset($this->options->webmaster_verify_status->bing) && !empty($this->options->webmaster_verify_status->bing) && $this->options->webmaster_verify_status->bing == 'success'){
            $notificatoin =  __( '%s Successfully Verified! %s your website has been successfully verifed by Bing webmaster tool.', SR_TEXTDOMAIN );
