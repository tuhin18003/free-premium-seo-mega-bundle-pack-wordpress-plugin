...
//			}
                        ...
                        $classname = $avail[ $name ][1];
                        $newClassPath = "CsSeoMegaBundlePack\\Controllers\\AdminPageBuilder\\BacklinkManager\\Tabs\\redirection_301\\actions\\" . $classname;
                    
			$obj = new $newClassPath( array( 'action_code' => $code ) );
			$obj->type = $name;
			return $obj;
		}
