...
class YandexActionHandler {
     ...
     */
    public function Cs_yandexMetaTag(){
        $_aios_nonce = $this->http->get('_wpnonce', false);
        //check security
        AjaxHelpers::check_ajax_referer( 'yandex-webmaster-verification', $_aios_nonce, true );
        ...
        if( !empty($meta_tag)){
            ...
            $get_webmaster_data['yandex'] = $meta_tag;
        ...
        $json_data = array(
            ...
            'text' => __( 'Yandex Meta tag has been addes successfully & added to your website.', SR_TEXTDOMAIN ),
        );
