...
//        return $tbUrl . $qStrings[0]; 
//        return print_r($qStrings);
...
class GTB_Request extends GTB_PageRank
{
  ...
  private static function GetWithCurl($url) {
      $ua = \CsSeoMegaBundlePack\Library\CsSerp\Helper\HttpRequest::getUserAgent();
      $curlopt_proxy = \CsSeoMegaBundlePack\Library\CsSerp\Helper\HttpRequest::getProxy();
      $curlopt_proxyuserpwd = \CsSeoMegaBundlePack\Library\CsSerp\Helper\HttpRequest::getProxyUserPwd();
