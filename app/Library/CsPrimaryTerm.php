...
class CsPrimaryTerm {
    ...
    public function get_primary_term() {
            $primary_term = get_post_meta( $this->post_ID, 'aios_primary_' . $this->taxonomy_name, true );
    ...
    public function set_primary_term( $new_primary_term ) {
            update_post_meta( $this->post_ID, 'aios_primary_' . $this->taxonomy_name, $new_primary_term );
    }
